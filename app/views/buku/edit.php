...
name="tanggal" value="<?= $data['buku']['tanggal'];?>" readonly>
 </div>
 <div class="form-group">
 <label >Nama</label>
 <input type="text" class="form-control" placeholder="Masukkan nama peminjam..." 
name="nama" value="<?= $data['buku']['nama'];?>">
 </div>
 <div class="form-group">
 <label >Kelas</label>
 <select class="form-control" name="kelas">
 <option value="<?= $data['buku']['kelas'];?>">Pilih</option>
...
name="judul_buku" value="<?= $data['buku']['judul_buku'];?>">
 </div>
 <div class="form-group">
 <label >Banyaknya</label>
 <input type="number" class="form-control" placeholder="" 
name="banyaknya" value="<?= $data['buku']['banyaknya'];?>">
 </div>
 <div class="form-group">
 <label >Tanggal Kembali</label>
 <input type="date" class="form-control" placeholder="Masukan judul buku" 
name="tanggal_kembali" value="<?= $data['buku']['tanggal_kembali'];?>">
 </div>
 <div class="form-group">
